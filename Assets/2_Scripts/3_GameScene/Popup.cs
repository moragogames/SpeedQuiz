...
public class Popup : MonoBehaviour
{
    ...
    private void Update()
    {
        myScoreText.text = "점수 : " + User.Instance.myScore.ToString();
        correctCount.text = "맞춘 갯수 : " + User.Instance.correctCount.ToString();
    }
    ...
    public void SetGameOverPanel(bool _g) // 게임오버
    {
        panelBack.SetActive(true);
